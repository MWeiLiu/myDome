...
zjs.meitu = "";//美图API所在文件位置/meitu.aspx
...
zjs.opers = "=,>,<,>=,<=";
zjs.memberGrade = "1|初始级别,2|高级级别";
zjs.memberGradeC = "|请选择," + zjs.memberGrade;
zjs.state = "1|开启,0|结束";
zjs.prizetype = "0|空奖,1|10金币,2|实物";
zjs.orderstate = "unused_shouldpay|待支付,unused_paying|支付中,unused_shouldsend|待发货,unused_shouldreceive|待收货,using_process|使用中,used_shouldrecover|待收回,used_returndeposit|待退押金,used_success|交易成功,cancelled|已取消,unused_refunding|退款申请中,unused_refund_success|退款成功,unused_refund_fail|退款失败";
//常用正则表达式
zjs.validatorRules = {
    "required": {
        "alertText": "* 必填 "
