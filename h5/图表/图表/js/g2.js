...
function(t, e) {
	...
	return function(t) {
		...
		"use strict";
		var i = {};
		i.Chart = n(306), i.Util = n(1), i.Global = n(4), i.Stat = n(15), i.Stat.map = n(252), i.Stat.tree = n(145), i.Stat.treemap = n(148), n(181), i.Scale = n(86), i.Shape = n(117), i.Frame = n(2), i.Theme = n(40), i.Canvas = n(5), i.Coord = n(89), i.Base = n(10), i.ColorCalculate = n(78), i.Layout = n(193), i.Animate = n(111), i.Plugin = {};
		var r = n(58);
		...
		var i = n(27);
		i.summary = n(231), i.bin = n(207), i.smooth = n(221), i.density = n(211), i.region = n(214);
		var r = n(2);
		...
		o.ATTRS = {
			...
			execAnimate: function(t) {
				var e, n = this,
					...
					h = n.getEndMatrix();
				h = s.multiply(l, h), e = i.mix({}, c, {
					matrix: h
				}), t.animate(e, o, u, function() {
		...
		i.augment(a, {
			...
			drawFacetTitle: function(t, e, n) {
				...
				d[h] = g[h], d[f] = g[f] + s * p, n.addShape("Text", {
					attrs: d
				})
			},
		...
		function s(t, e, n, i) {
			var r, a, s, o = 3 * t - 9 * e + 9 * n - 3 * i,
				...
				c = 3 * n - 3 * i,
				h = [];
			if (l.equal(o, 0)) l.equal(u, 0) || (r = -c / u, r >= 0 && r <= 1 && h.push(r));
			else {
				var f = u * u - 4 * o * c;
		...
		var i = (n(1), "\t\n\x0B\f\r \xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029"),
			...
			s = function(t) {
				...
				return String(t).replace(r, function(t, i, r) {
					...
					else for (; s.length >= e[o] && (n.push([i].concat(s.splice(0, e[o]))), e[o]););
				}), n
			},
			o = function(t, e) {
			...
			c = function(t) {
				...
				for (var h, f, g = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), p = l, d = t.length; p < d; p++) {
					...
					else for (var y = 0, _ = f.length; y < _; y++) h[y] = f[y];
			...
			u = {
				...
				getInterpolations: function(t, e) {
					...
					return i.each(t.attrs, function(t, i) {
						typeof t == typeof e.attrs[i] && ("path" === i ? n.attrs[i] = u.interpolation({
							path: t,
							type: "path"
						}, {
							path: e.attrs[i],
							type: "path"
						}) : n.attrs[i] = u.interpolation(t, e.attrs[i]))
					}), e.matrix && t.matrix && !o.equal(t.matrix, e.matrix) && (n.matrix = u.interpolation(t.matrix, e.matrix)), n
				},
		...
		r.augment(s, {
			...
			tryStep: function(t) {
				...
				return !e || e.get("destroyed") ? (this.needsDestroy = !0, !1) : this.step(t)
			},
			step: function(t) {
				var e, n, s, o = this.target,
					u = this.startTime,
					c = t - u,
					l = this.duration,
					h = this.startKeyFrame,
					f = this.endKeyFrame,
					g = this.easing,
					p = this.interpolations;
		...
		i.CFG = {
			...
			renderTitle: function() {
				...
				if (e.text) {
					...
					h.rotate = d * (180 / Math.PI), h.x = g.x, h.y = g.y, t.addShape("Text", {
						elCls: s + "-title",
						attrs: h
					})
				}
			...
			autoRotateLabels: function() {
				...
				if (e) {
					var i, r, s = t.get("labelOffset") || 10,
						...
						u = t.get("titleOffset"),
						l = t.getAxisVector();
					if (c.equal(l.x, 0) && n && n.text) r = t.getMaxLabelWidth(e), r + s > u - o && (i = Math.acos((u - o) / (r + s)) * -1);
		...
		var i = n(71);
		i.ShowLabels = n(171), t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(5).Group,
			r = n(1),
		...
		a.CFG = {
			...
			_onMouseMove: function(t) {
				var e = t.currentTarget.get("cursor"),
				...
				return t.each(function(t) {
					...
					if (i.isArray(r) && i.isArray(l)) e = t[a.fromWeightField], n = t[a.toWeightField], t[s] = [r[0], r[0] + e, l[0], l[0] + n], t[o] = [r[1], r[1], l[1], l[1]], g.push(t);
						...
						var p = a._findObj(r),
							d = a._findObj(l);
						if (p && d) {
							var v = p[h] ? p[h] : p.x - .5 * p.width,
								m = d[f] ? d[f] : d.x - .5 * d.width;
		...
		}, r.Cat = n(87), r.cat = function(t) {
			return new r.Cat(t)
		}, r.Pow = n(268), r.pow = function(t) {
			return new r.Pow(t)
		}, r.Log = n(267), r.log = function(t) {
			return new r.Log(t)
		}, r.Identity = n(266), r.I = function(t) {
			return new r.Identity(t)
		}, r.Time = n(270), r.time = function(t) {
			return new r.Time(t)
		}, r.TimeCat = n(269), r.timeCat = function(t) {
		...
		function a(t, e, n) {
			var i, a, s = g.exec(t),
				o = c.mod(c.degreeToRad(parseFloat(s[1])), 2 * Math.PI),
				u = s[2],
				l = e.getBBox();
			o >= 0 && o < .5 * Math.PI ? (i = {
				x: l.minX,
			...
			var h = Math.tan(o),
				f = h * h,
				p = (a.x - i.x + h * (a.y - i.y)) / (f + 1) + i.x,
				d = h * (a.x - i.x + h * (a.y - i.y)) / (f + 1) + i.y,
				v = e.get("context"),
			...
			createPath: function(t) {
				...
				if (t = t || self.get("context"), t.beginPath(), t.arc(n, i, a, s, o, c), h) {
					var f = {
						...
						g = new r(-a * Math.sin(o), a * Math.cos(o));
		...
		c.ATTRS = {
			...
			createPath: function(t) {
				...
				if (t = t || self.get("context"), !(i.isNull(n) || i.isNull(r) || i.isNull(a) || i.isNull(o))) if (t.beginPath(), t.moveTo(n[0], n[1]), l) {
					var h = new u(o[0] - a[0], o[1] - a[1]),
						f = s.getEndPoint(h, new u(o[0], o[1]), c);
			...
			createPath: function(t) {
				...
				if (i.isArray(r)) {
					...
					for (var u = 0, c = r.length; u < c; u++) if (u === c - 1 && s) {
						...
						if (l && i.isFunction(f)) {
							var p = f(),
								d = o.getEndPoint(p, new h(g.x, g.y), a);
		...
		l.ATTRS = {
			...
			getPoint: function(t) {
				...
				return s || (this.__setTcache(), s = this.tCache), i.each(s, function(i, r) {
					...
					x: o.at(a[n][0], a[n + 1][0], e),
					y: o.at(a[n][1], a[n + 1][1], e)
				}
			}
		}), t.exports = l
	}, function(t, e, n) {
		...
		function a(t, e) {
			var n, i, a = t.points || t.get("origin").points,
				s = r(a),
				o = e.get("startAngle"),
				u = e.get("endAngle"),
				c = u - o;
		...
		function u(t, e) {
			...
			n = a[0].y - a[1].y <= 0 ? r.maxY : r.minY, i = new b(s, n, 1), t.apply(i), t.transform([
				["t", -i.x, -i.y],
				["s", 1, .01],
				["t", i.x, i.y]
			]);
		...
		function c(t, e) {
			var n, i, r = t.getBBox(),
				...
				u = t.id || t.get("id"),
				c = t.get("origin") && t.get("origin").index || 0;
			n = a[0].y - a[1].y > 0 ? r.maxX : r.minX, i = new b(n, s, 1), t.apply(i), t.transform([
				["t", -i.x, -i.y],
				["s", .01, 1],
				["t", i.x, i.y]
			]);
		...
		function l(t, e) {
			var n = {
				...
				i = t.id || t.get("id"),
				r = t.get("index") || t.get("origin") && t.get("origin").index || 0,
				a = o(e, r, i, n);
		...
		function h(t, e) {
			var n = t.getBBox(),
				...
				a = new b(i, r, 1),
				s = t.id || t.get("id"),
				u = t.get("origin") && t.get("origin").index || 0;
			t.apply(a), t.transform([
				["t", -a.x, -a.y],
				["s", .01, .01],
				["t", a.x, a.y]
			]);
		...
		function f(t, e) {
			var n = t.getBBox(),
				...
				a = new b(i, r, 1),
				s = t.id || t.get("id"),
				u = t.get("index") || t.get("origin") && t.get("origin").index || 0;
			t.apply(a);
			var c = {
				transform: [
					["t", -a.x, -a.y],
		...
		function g(t, e) {
			if ("path" === t.get("type")) {
				var n = t.id || t.get("id"),
					i = t.get("origin") && t.get("origin").index || 0,
		...
		function p(t, e) {
			if ("path" === t.get("type")) {
				var n = t.id || t.get("id"),
					i = t.get("index") || t.get("origin") && t.get("origin").index || 0,
					r = _.pathToAbsolute(t.attr("path")),
					a = {
						path: [r[0]],
						destroy: !0
		...
		function d(t, e, n, r, a) {
			...
			r ? (u.attr("startAngle", r), u.attr("endAngle", r), s = {
				endAngle: a
			}) : s = u.endState, u.set("canvas", c), t.attr("clip", u);
			var f = o(e, h, l, s);
		...
		function m(t, e) {
			var n = t.id || t.get("id"),
				i = t.get("index") || t.get("origin") && t.get("origin").index || 0,
				r = t._getAttr("strokeOpacity") || 0,
				a = t._getAttr("fillOpacity") || 0,
				s = {
		...
		function d(t, e, n, i, o) {
			...
			return M.length > 1500 ? void n.draw() : void(o ? y.each(M, function(o) {
				...
				if (o.isStash ? (c = o, h = a(d, e)) : (c = a(d, t), h = o), c && h && !h.get("destroyed")) {
					if (!f(c, h)) return;
					if (b = p(c.animateType, "update", c), m = g(c.animateType, i, "update", b.animation), y.isFunction(m)) m = m(c, h, b, i);
					else {
						if (x = h.getMatrix(), v = r(c.attrs, s(h)), S = w.equal(c.matrix, x), !v && S) return;
						v && S ? (h.attr(v.attrs1), _ = v.attrs2) : v || S ? (h.attr(v.attrs1), h.setMatrix(c.matrix), _ = y.simpleMix({
							matrix: x
						}, v.attrs2)) : (h.setMatrix(c.matrix), _ = {
							matrix: x
						}), h.animate(_, b.duration, b.easing)
					}
				} else if (c && !h) {
		...
		}, y = n(1), _ = n(5), S = n(257), b = n(111), w = _.Matrix.Matrix3, M = {
			text: "text",
			elements: "elements",
			rotate: "rotate",
			textAlign: "textAlign",
		...
		function i(t, e) {
			return "matrix3" === t.type && "matrix3" === e.type ? l.matrix(t, e) : "path" === t.type && "path" === e.type ? s.path(t, e) : a.isArray(t) && a.isArray(e) ? o.array(t, e) : a.isObject(t) && a.isObject(e) ? u.object(t, e) : c.singular(t, e)
		}
		function r(t, e) {
		...
		i.extend(a, r), i.augment(a, {
			...
			processNodes: function(t, e, n) {
				...
				if (i.isArray(t) && t.length) {
					...
					(o = g.length) > 0;) u.push(a = g[o - 1]), u.area += a.area, "squarify" !== l || (s = r.worst(u, d)) <= p ? (g.pop(), p = s) : (u.area -= u.pop().area, r.position(u, d, e, !1), d = Math.min(e.dx, e.dy), u.length = u.area = 0, p = 1 / 0);
		...
		s.ATTRS = {
			...
			_refresh: function(t) {
				for (var e, n, r = this.get("tweens"), a = (this.get("canvases"), this.get("autoDraw")), s = this.get("autoDestroy"), o = [], u = [], c = 0; c < r.length; c++) n = r[c], e = n.canvas, n.needsDestroy && s ? n.destroy() : n.destroyed || n.needsDestroy || n.tryStep(t), n.destroyed || o.push(n), i.inArray(u, e) || n.destroyed || u.push(e);
				a && this.draw(), this.set("canvases", u), this.set("tweens", o)
			},
			_update: function() {
		...
		i.augment(s, {
			...
			timeline: null,
			startTime: null,
			append: function(t, e, n, s) {
				var o, u = i.guid("tween_"),
					c = this.target,
					l = (this.tweens, this.timeline),
					h = this.startTime,
					f = r.getKeyFrameByProps(c, e),
					g = f[0],
					p = f[1],
					d = r.getInterpolations(g, p);
			...
			getLinePath: function() {
				...
				if (Math.abs(o - s) === 2 * Math.PI) c = [
					...
					var l = t._getCirclePoint(s),
						...
						g = s > o ? 0 : 1;
					if (u) {
						var p = t.getSideVector(u * r, l),
							d = t.getSideVector(u * r, h),
							v = {
								x: p.x + n,
								y: p.y + i
							},
		...
		s.extend(r, a), r.CFG = {
			...
			_renderUI: function() {
				r.superclass._renderUI.call(this), this._drawLines()
			},
			_drawLines: function() {
				var t = this,
					e = t.get("line"),
					n = t.get("items");
				n && n.length > 0 && (t._precessItems(n), t._drawGridLines(n, e, o + "-line"), t.get("minorCount") && t.drawMinorLines())
			},
			...
			_drawGridLines: function(t, e, n) {
				var i, r, a, o, u = this,
					c = this.get("type"),
					l = this.get("smooth");
				return 0 !== t.length && void("line" === c ? s.each(t, function(t) {
					l ? (r = [], s.each(t, function(t) {
						r.push(t.x), r.push(t.y)
					}), a = s.catmullRom2bezier(r), a.unshift(["M", t[0].x, t[0].y])) : (a = [], s.each(t, function(t, e) {
				...
				}) : "polygon" === c ? s.each(t, function(t) {
					a = [], s.each(t, function(t, e) {
						0 === e ? a.push(["M", t.x, t.y]) : a.push(["L", t.x, t.y])
					}), o = s.mix({}, e, {
						path: a
					}), i = u.addShape("path", {
			...
			_drawOddEven: function(t, e, n) {
				var i, r, a = this,
					s = a.get("odd"),
					u = a.get("even");
				n % 2 === 0 ? u && (r = a._getBackItem(e, t, u), i = "even") : s && (r = a._getBackItem(e, t, s), i = "odd"), r && a.addShape("Path", {
					elCls: o + "-" + i,
					attrs: r
				})
			},
			_getBackItem: function(t, e, n) {
				var i = s.substitute("M {x1} {y1} L{x2} {y2}", t);
				return i += s.substitute("L{x2} {y2} L{x1} {y1}Z", e), n = s.mix({}, n, {
					path: i
				})
			},
		...
		var i = n(69);
		i.Abstract = n(33), i.Circle = n(166), i.MultLine = n(170), i.Helix = n(168), t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(1),
			r = n(69),
		...
		u.CFG = {
			...
			_warpHorizontal: function() {
				...
				i.getBBox().width > s && r.each(a, function(i) {
					n = i.getBBox(), t = n.width + o, e = n.height + u, h = l, l += t, l > s ? (l = t, c++, i.move(0, c * e)) : i.move(h, c * e)
				})
			},
			_bindUI: function() {
			...
			_addItem: function(t) {
				...
				t.marker && (t.checked || (t.marker.fill = a, t.marker.stroke && (t.marker.stroke = a), r.isObject(t.word) ? t.word.fill = a : (t.word = {}, t.word.fill = a)), s.marker = t.marker), this.addEachItem(e, {
					word: t.word,
		...
		l.CFG = {
			...
			_renderBackground: function() {
				var t, e = this.get("attrType"),
					n = this.get("rangeElement"),
					i = n.get("middleHandleElement");
			...
			_addVerticalTrigger: function(t, e, n) {
				var r = this.get("rangeElement"),
					...
					l = this.get("layout"),
					h = "vertical" === l ? "ns-resize" : "ew-resize";
		...
		f.CFG = {
			...
			_renderContent: function() {
				...
				if (f && f.clear(), n) {
					...
					this.set("titleShape", g.getFirst())
				}
				r.each(e, function(e, n) {
					var i = r.mix({}, a, {
						text: e.name ? e.name + ":" : ""
			...
			setPosition: function(t, e) {
				var n, i = this.get("canvas"),
					...
					c = this.get("offset"),
					l = this.get("crossLineShapeX"),
					h = this.get("crossLineShapeY"),
					f = this.get("contentGroup"),
					g = f.getBBox(),
					p = this.get("animate"),
					d = !0,
					v = t,
					m = e;
				if (o && this.get("customFollow") ? (n = r.getWidth(o) + 2 * c, t -= n, e = e - r.getHeight(o) - 2 * c) : (n = g.width + c, t -= n, e -= g.height), u && (u.isInRange(t, e) || (u.isInHorizontal(t) || (u.tr.x - u.tl.x >= 2 * n ? (t = Math.max(u.tl.x, v) + c, d = !1) : (t = u.tl.x, e -= c)), u.isInVertical(e) || (e = u.tl.y))), this.get("x") !== t || this.get("y") !== e) if (h && (d ? h.move(v, 0) : h.move(t - c, 0)), l && l.move(0, m), s) this.moveCustom(t, e, d);
				else {
					var x = new a.Matrix3;
					x.translate(t, e), p && this.get("visible") ? f.animate({
						matrix: x
					}, this.get("duration")) : (f.setMatrix(x), this.get("visible") || this.show(), i.draw())
				}
			},
			...
			show: function() {
				var t = this.get("crossLineShapeX"),
					e = this.get("crossLineShapeY"),
			...
			hide: function() {
				var t = this,
					e = t.get("customDiv"),
					n = t.get("crossLineShapeX"),
					i = t.get("crossLineShapeY"),
					r = t.get("canvas"),
			...
			remove: function() {
				var t = this,
					e = t.get("crossLineShapeX"),
					n = t.get("crossLineShapeY"),
					i = t.get("customDiv"),
					r = t.get("html");
		...
		function f(t, e, n, i, r) {
			...
			if (f[0] && f[1] && f[2]) v = d(t, l[0], n, i) < d(t, l[1], n, i) ? h(l[0], n, i) : h(l[1], n, i), m = !0;
			else for (var x = 0; x < 3; x++) if (f[x]) {
				v = h(l[x], n, i), m = !0;
				break
			}
		...
		var i = (n(1), n(15)),
			r = n(77);
		r.Weight = n(76), r.Sankey = n(182), i.link = function(t, e) {
			return new r({
				dims: t,
				nodes: e
			})
		...
		var i = n(26);
		i.Dodge = n(189), i.Jitter = n(190), i.Stack = n(191), i.Symmetric = n(192), t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(1),
			r = n(26),
		...
		var i = {};
		i.Tree = n(196), i.Linear = n(80), i.Sankey = n(194), t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(1);
		n(197);
					...
					if (c && c.length && !t[o]) {
						...
						if (t.parent && 0 === r) {
							var x = n._getMaxPreXParent(t.parent),
								y = n._preX[l - 1] || 0;
							if (x) if (y = n._preX[x.level] || 0, x === t.parent && 1 === t.parent.children.length);
							else {
								var _ = x._alignCount;
			...
			x = function(t) {
				...
				if (n === e && (n = e + v), h.isNull(x)) {
					...
					if (S > .51) {
						...
						for (var L = a(e), F = s(e, n), O = 0; O <= F + w; O += w) _.push(o(P, O + L));
						x = null
					} else if (x > .5 * C) {
						M = new Date(e), b = M.getFullYear(), w = M.getMonth(e), A = Math.ceil(x / C);
						var R = M.getDate(),
							N = u(e, n);
						x = A * C;
						...
						var V = l(e, n),
							Y = Math.ceil(x / p);
						x = Y * p;
						for (var j = 0; j <= V + Y; j += Y) _.push(e + j * p)
					} else {
						x < 1e3 && (x = 1e3), e = 1e3 * Math.floor(e / 1e3);
						var G = Math.ceil((n - e) / 1e3),
							H = Math.ceil(x / 1e3);
						x = 1e3 * H;
						for (var q = 0; q < G + H; q += H) _.push(e + 1e3 * q)
					}
				}
				if (!_.length) {
		...
		var r = n(47);
		r.mean = n(225), r.median = n(226), r.linear = n(222), r.quadratic = n(228), r.cubic = n(218), r.log = n(224), r.pow = n(227), r.exp = n(219);
		var a = n(223);
		...
		r.extend(u, i), r.augment(u, {
			...
			execSmoothThreeDim: function(t, e) {
				for (var n = this, i = e[0].length, r = e[1].length, s = t.length, u = n.kernelType, c = a[u], l = [], h = [], f = e[0][1] - e[0][0], g = e[1][1] - e[1][0], p = 0; p < i; p++) for (var d = 0; d < r; d++) {
					for (var v, m, x, y, _, S = 0, b = 0, w = 0, M = 0, A = 0, T = 0, C = 0, k = 0, P = 0, I = e[0][p], D = e[1][d], L = n.getWindowWidth([I, D], t, [f, g]), F = L[0], O = L[1], R = 0; R < s; R++) m = t[R][0], x = t[R][1], y = t[R][2], v = c((I - m) / F) * c((D - x) / O), 0 !== v && (S += v, b += v * m, w += v * x, M += v * m * x, A += v * m * m, T += v * x * x, C += v * y, k += v * m * y, P += v * x * y);
					var N = [
						[S, b, w],
						[b, A, M],
						[w, M, T]
		...
		var i = n(12);
		i.Image = n(245), i.Text = n(249), i.Line = n(246), i.Tag = n(248), i.Rect = n(247), i.Arc = n(243), i.Html = n(244), t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(1),
			r = n(12),
		...
		var i = n(16),
			...
			c = n(261),
			l = n(265);
		i.groupAngle = r, i.groupCircle = a, i.groupWaveh = s, i.groupScaleXY = o, i.groupScaleY = u, i.groupScaleX = c, i.groupWaves = l, t.exports = i
	}, function(t, e, n) {
		"use strict";
		var i = n(16),
			r = n(1),
		...
		a.extend(l, o), a.augment(l, {
			...
			addShape: function(t, e) {
				...
				e = e || {};
				var r = c[t];
				return r || (r = a.ucfirst(t), c[t] = r), e.canvas = i, e.type = t, n = new u[r](e), this.add(n), n
			},
			...
			__setEvn: function(t) {
				var e = this;
				t.__cfg.parent = e, t.__cfg.context = e.__cfg.context, t.__cfg.canvas = e.__cfg.canvas;
			...
			getBBox: function() {
				...
				a.each(o, function(t) {
					if (t.get("visible")) {
						var a = t.getBBox();
						if (!a) return !0;
						var o = new s(a.minX, a.minY, 1),
							u = new s(a.minX, a.maxY, 1),
							c = new s(a.maxX, a.minY, 1),
							l = new s(a.maxX, a.maxY, 1);
						t.apply(o), t.apply(u), t.apply(c), t.apply(l);
						var h = Math.min(o.x, u.x, c.x, l.x),
							f = Math.max(o.x, u.x, c.x, l.x),
							g = Math.min(o.y, u.y, c.y, l.y),
		...
		var i = n(1),
			r = n(3).Vector3,
			a = ["strokeStyle", "fillStyle", "globalAlpha"],
			s = ["circle", "ellipse", "fan", "polygon", "rect", "path"],
			o = {
				r: "R",
				opacity: "Opacity",
				lineWidth: "LineWidth",
		...
		function u(t, e, n, i, r, a, u) {
			var c = l.mod(l.degreeToRad(u), 2 * Math.PI),
				h = t.x,
				f = t.y,
				g = e.x,
				p = e.y,
				d = Math.cos(c) * (h - g) / 2 + Math.sin(c) * (f - p) / 2,
				v = -1 * Math.sin(c) * (h - g) / 2 + Math.cos(c) * (f - p) / 2,
				m = d * d / (r * r) + v * v / (a * a);
			...
			var y = x * r * v / a,
				_ = x * -a * d / r,
				S = (h + g) / 2 + Math.cos(c) * y - Math.sin(c) * _,
				b = (f + p) / 2 + Math.sin(c) * y + Math.cos(c) * _,
				w = o([1, 0], [(d - y) / r, (v - _) / a]),
				M = [(d - y) / r, (v - _) / a],
				A = [(-1 * d - y) / r, (-1 * v - _) / a],
				T = o(M, A);
		...
		c.augment(_, {
			init: function(t, e) {
				...
				case "T":
					...
					break;
				case "C":
					l ? (a = i(p, d, g), s = i(f[3], f[4], g), o = i(f[5], f[6], g)) : (a = {
						x: p,
						y: d
					}, s = {
						x: f[3],
		...
		r.augment(h, {
			...
			_getAxisDefaultCfg: function(t, e, n, i, a) {
				...
				if ("cartesian" !== f || r.isNull(u) || u && 1 === u.rows && 1 === u.cols)"cartesian" === f && (s.title = {
					...
					s.title = {
						text: e.alias || e.dim
					}, "tree" === m ? ("y" === n && 0 !== u.originColIndex && 0 !== v || "x" === n && u.children) && (s.labels = null, s.title = null) : "circle" === m ? (s.labels = null, s.title = null) : ("mirror" !== m && "y" === n && (0 !== v && "left" === i || v !== p - 1 && "right" === i) && (s.labels = null, s.title = null), "rect" === m ? "x" === n && 0 !== d && (s.labels = null, s.title = null) : "list" === m ? "x" === n && d !== g - 1 && p * d + v + 1 + p <= u.count && (s.labels = null, s.title = null) : "mirror" === m && "x" === n && (1 === g && 1 === v || 2 === g && 0 === d) && (s.labels = null, s.title = null)), "y" === n && s.title && d !== Math.floor(g / 2) && (s.title = null), "x" === n && s.title && v !== Math.floor(p / 2) && (s.title = null)
				}
				if (s = r.mix(!0, {}, c.axis[i], s, l[e.dim]), s.ticks = e.getTicks(), t.isPolar && !e.isCategory && "x" === n && ("clock" === t.type ? s.ticks[0].text = "" : "gauge" !== t.type && s.ticks.pop()), "y" === n) {
					...
					if (h / y < _) {
						var S = [],
							...
							w = Math.floor(y / b);
						w < 1 && (w = 1), S.push(x[0]);
						for (var M = w; M <= y - 2; M += w) S.push(x[M]);
			...
			createAxis: function(t, e, n, i) {
				var a = this,
					s = i && r.isBoolean(i.visible) ? i.visible : a.visible;
				if (s) {
					var o = {};
		...
		i.augment(a, {
			...
			createCoord: function(t, e) {
				var n, a, s = this.chart.get("options"),
					o = s.coord,
					u = this,
					c = o && o.type ? o.type : u.type,
					l = i.mix({
						start: t,
						end: e
					}, o && o.cfg);
		...
		i.augment(a, {
			...
			onDown: function(t) {
				...
				var i = e.get("plotRange"),
					...
					o = t.x / r,
					u = t.y / r;
				if (!(o < a.x || o > s.x || u < a.y || u > s.y) && (this.startPoint = {
					x: o,
					y: u
				}, this.selectable)) {
					this.rangeSelected = !0;
					var c = this.rangePlot;
					if (!c) {
						var l = this._getCanvas();
						c = l.addGroup(), c.initTransform(), this.rangePlot = c
					}
					var h = this._getPointInfo(t);
					e.fire("rangeselectstart", this._getEventObj(t, h, h.views));
					var f = t.event;
					f.stopPropagation(), f.preventDefault(), this._bindCanvasEvent()
				}
			},
				...
				if (!(Math.abs(n.x - a) <= 1 && Math.abs(n.y - s) <= 1)) {
					...
					if (i.each(h.views, function(t) {
						...
						var f = o.getXScale(),
							g = o.getYScales()[0],
							p = c.get("plotRange"),
							d = Math.abs(p.start.y - p.end.y),
							v = Math.abs(p.start.x - p.end.x),
							m = [(n.x - p.start.x) / v, (l.x - p.start.x) / v].sort(),
		...
		i.augment(s, {
			...
			_createFacetView: function(t) {
				...
				return n.set("options", e.get("options")), n.set("plotContainer", e.get("plotContainer")), n.set("frontPlot", e.get("frontPlot")), n.set("backPlot", e.get("backPlot")), n.set("scales", e.get("scales")), n.set("stats", e.get("stats")), n
			},
			generateFacets: function(t, e) {
				...
				var u = n._getFacetClass(e.type),
					c = new u(e),
					l = c.generateFacets(t),
					h = s.get("plotContainer"),
					f = h.addGroup();
		...
		c.augment(x, {
			...
			_alignLegend: function(t, e, n, i) {
				...
				if ("left" === i || "right" === i) {
					...
					var x = 0;
					c && (x = c.bl.x + (c.getWidth() - n.totalWidth) / 2), l = x, h = "top" === i ? p : u - v.height - p, e && (l = e.get("x") + e.getBBox().width + d)
				}
				t.move(l + f, h + g)
			},
			_setItemChecked: function(t, e, n, i) {
				...
				if (i) {
					if (!n) return;
					var p = s.getAllGeoms(),
						d = t.get("itemsGroup").get("children");
					c.each(p, function(t) {
						l !== t && t.setVisible(!1)
					}), c.each(d, function(t) {
						if (t !== u) {
			...
			addMixedLegend: function(t) {
				...
				c.each(t, function(t, e) {
					if (t.type = null, t.marker = r.getMarkerCfg(a, t), t.word = c.mix({
						fill: "#333",
						textBaseline: "middle"
					}, n.word), i && e > 0) {
						var s = t.geom;
						s.setVisible(!1), t.checked = !1
					} else t.checked = !0
				});
				var s = e.container,
					o = this.getPosition(),
			...
			addLegend: function(t, e, n, u) {
				...
				if (l.legendCfg.visible) {
					...
					if (!h || h[g] !== !1) {
						...
						var m, x, y = e.scales,
							_ = [];
						if (1 === y.length || t.isLinear) _ = l._getLegendItems(t, e, n, u), x = t.dim, m = l._addLegend(t, d, _, p, e);
						else {
							var S = y[1],
								b = t.getTicks(),
								w = [];
			...
			_getCategoryItems: function(t, e, n, i, r) {
				var s, o, u = this,
					...
					p = "point",
					d = t.dim,
					v = h.marker || h[d] && h[d].marker || "circle",
					m = "single" === h.mode || h[d] && "single" === h[d].mode,
					x = h.word || h[d] && h[d].word || {};
				return c.each(l, function(l, h) {
					...
					var y = l.value,
						...
						b = u._mappingValues(_, e, r);
					"color" === e.type ? S.color = b : "shape" === e.type ? (p = n.get("shapeType") || n.get("type"), v = b) : "size" === e.type && (s = b);
					var w = g.getShape(p),
						M = w.getMarkerCfg(v, S);
					c.isNull(s) || (M.radius = s);
					var A = !0;
					c.isNull(r) ? A = m ? i ? u._isFiltered(t, i, y) : 0 === h : !i || u._isFiltered(t, i, y) : (_ = r + "*" + _, o = a(o, r)), f.push({
						name: o,
						checked: A,
						type: null,
						marker: M,
			...
			_addLegend: function(t, e, n, i, r) {
				var a, s, o = this,
					u = o._getLayoutType(i);
				if (t.isLinear) s = h.Continuous, a = c.mix({
					layout: u,
					attr: r
				}, e);
				else {
					s = h.Category;
					var l = o.plotRange,
						f = "right" === i || "left" === i ? l.bl.y - l.tr.y : l.tr.x - l.bl.x;
					a = c.mix(!0, {
						maxLength: f,
						layout: u,
						items: n
		...
		i.augment(c, {
			...
			createScale: function(t, e, n) {
				...
				else if (o[t] || i.indexOf(e.colNames(), t) !== -1) if (o[t]) {
					var u = o[t];
			...
			_getFilterFunction: function(t, e) {
				var n, r, a, s, o = t.dim;
				return n = t.isCategory ? "timeCat" === t.type ?
				function(t) {
		...
		o.augment(g, {
			...
			_setTooltipCrosshairs: function() {
				...
				}), i.length && "cartesian" === i[0].get("coord").type && 1 === r.length && o.indexOf(f, r[0]) > -1 && o.mix(e, {
					crosshairs: !0
				}), e
			},
			...
			_setTooltip: function(t, e, n) {
				...
				if (!a || a.x !== e.x || a.y !== e.y) {
					...
					r.get("visible") || u.fire("tooltipshow", {
						...
						y: l,
						items: n
					}), r.setContent(t, n), r.setPosition(c, l), r.show()
				}
			},
		...
		t.exports = {
			_initAttrs: function() {
				...
				r.each(e, function(e) {
					...
					var a = [],
						s = ["position", "color", "shape", "opacity", "size"];
					r.each(e, function(n, i) {
						if (s.indexOf(i) !== -1) {
							var o, u;
			...
			_initShape: function(t, e) {
				var n = {};
				if (t.callback && (n.callback = t.callback), t.shapes) n.arr = t.shapes;
				else {
					var i = /[A-Z].*$/;
			...
			_parseDims: function(t, e, n, i) {
				...
				if (t.isStat && (a = t, t.hasInited || (a.init(), a.hasInited = !0), t = a.getDims(), s._addStat(a)), r.isString(t) && t.indexOf("+") !== -1) {
					var o = [],
						u = this.get("scaleAssist"),
						c = t.replace(/\s+/g, "").split("*");
					r.each(c, function(t) {
						var e = t.replace(/\(|\)|\s+/g, "").split("+"),
							n = e.join("+");
						o.push(n), e.length > 1 && (u.defs[n] = r.mix({}, u.defs[n], {
							dims: e
						}))
					}), t = o
		...
		function u(t) {
			var e = t.width,
				...
				o = a(r, !0),
				u = a(r, !0);
			return o.set("capture", !0), t.backCanvas = s, t.canvas = o, t.frontCanvas = u, t
		}
		function c(t) {
			var e = l.mix({}, p.plotCfg, t.plotCfg),
				n = s(t);
		...
		m.ATTRS = {
			...
			_renderLegends: function(t) {
				var e = this.get("legendAssist"),
					n = this.getAllGeoms(),
					r = this._getAllYScales(),
					a = [];
				if (l.mix(e.legendCfg, t), l.each(n, function(t) {
					var n = t.getLegendAttr();
					l.each(n, function(n) {
						var r = n.type,
							s = n.getScale(r);
						if ("identity" !== s.type && !i(a, s)) {
							a.push(s);
							var o, u = n.scales,
								c = 1 === u.length ? s.dim : s.dim + "*" + u[1].dim,
								l = t.get("chart"),
								h = l.get("options").filters;
							h && h[c] && (o = h[c]), e.addLegend(s, n, t, o)
						}
					})
				}), !a.length && r.length > 1) {
					var s = [];
			...
			_renderTooltip: function() {
				var t = this.get("options"),
					e = this.get("tooltipAssist");
				l.mix(e.cfg, t.tooltip), e.cfg.visible && e.renderTooltip()
			},
			legend: function(t, e) {
				var n = !0,
					i = {};
				return l.isBoolean(t) && (n = t), l.isObject(t) ? i = t : i[t] = e, i.visible = n, this._setOptions("legends", i), this
			},
			tooltip: function(t, e) {
				return l.isObject(t) ? (e = t, e.visible = !0) : (e || (e = {}), e.visible = t), this._setOptions("tooltip", e), this
			},
			facet: function(t, e) {
				var n = l.isString(t) ? [t] : t;
			...
			destroy: function() {
				if (!this.destroyed) {
					...
					this.fire("destroy"), this.clear(), this.get("backCanvas").destroy(), this.get("canvas").destroy(), this.get("frontCanvas").destroy(), this.events = {}, this.destroyed = !0, t.parentNode.removeChild(t), window.removeEventListener("resize", l.getWrapBehavior(this, "_initForceFitEvent"))
				}
			},
		...
		i.augment(a, {
			...
			position: function(t) {
				return this._setOptions("position", {
					field: t
				}), this
			},
			color: function(t, e) {
		...
		t.exports = {
			...
			_createGeom: function(t, e) {
				var n = t.type,
					...
					a = this.get("coord"),
					s = t.label;
				s && (o.isObject(s) && !s.isStat || (s = {
					field: s
				}), o.mix(s, this._getScalesAndStat(s.field, n, i)));
				var u = t.tooltip ? this._parseDims(t.tooltip, n, i).dims : null,
					l = null;
			...
			_drawCanvas: function() {
				var t = this.get("options"),
					e = t.animate || this.get("animate"),
					n = this.get("groupAnimate"),
					i = this.get("isUpdate"),
					r = this.get("canvas"),
					a = this.get("backCanvas"),
					s = this.get("frontCanvas"),
					o = this.get("coord");
		...
		m.ATTRS = {
			...
			_init: function() {
				var t = this.get("options"),
					e = this.get("data");
				this._initAssists(), this._initData(e, t.appendFields), this.set("views", []), this.set("geoms", []), this.set("scales", {})
			},
		...
		d.ATTRS = {
			...
			_groupAnimate: function(t) {
				var e = this,
					n = e.get("chart"),
					i = n.get("isUpdate"),
					r = n.get("animate") || e.get("animate"),
					a = e.get("animateCfg"),
					s = a && a.appear && a.appear.animation;
		...
		function s(t, e, n, i, r, s) {
			...
			for (var l, h, f, g = 0, p = n.length, d = 0, v = 0; v < p; v++) {
				var m = n[v],
					x = m.y;
				h = p - v, l = r > 0 ? (u - x) / h : (x - c) / h, v > 0 && (d = r > 0 ? (x - c) / v : (u - x) / v);
				var y;
				if (y = r > 0 ? h < p ? x - n[v - 1].y : x - c : h < p - 1 ? n[v - 1].y - x : u - x, g = v, l < s) {
					0 !== g && (g = v + 1);
					break
				}(d > 0 && d < s || y > 0 && y < s) && (f = v)
			}
			if (f) for (var _ = 0; _ <= f; _++) {
				var S = _ * s;
				a(n[_], S, i, e, t, !0)
			}
			var b = r < 0 && g <= p - 1 || r > 0 && g < p - 1;
			if (p > 1 && b) {
				var w = 0 === g ? 0 : g - 1,
					M = n[w],
					A = M.y,
					T = r > 0 ? u : c;
				if (h = p - w - 1, l = Math.abs(T - A) / h, h > 1 || l <= s) {
					l < s && (l = s);
					for (var C = p - 1; C >= w; C--) {
						var k = (p - 1 - C) * l;
						r < 0 && n[C].y > k && n[C].y > t.y || a(n[C], k, i, e, t, !1)
					}
				}
				for (var P = r > 0 ? c : u, I = !1, D = w - 1; D > 0; D--) {
					var L = n[D];
					if (!I && Math.abs(P - L.y) / (D + 1) < s && (I = !0), I) {
						var F = Math.abs(n[D + 1].y - T) + s;
						a(n[D], F, i, e, t)
					}
				}
			}
		...
		p.CFG = {
			...
			lineToLabel: function(t, e) {
				var n, a, s = this,
					...
					_ = i(t.angle),
					S = 1;
				_ && (h -= m / 2, l.equal(t.angle, Math.PI / 2) && (S = -1)), y.push(["M", v.x, v.y]), n = r(d, p, c + h / 2);
				var b = _ ? t.y + m / 2 * S : t.y;
				y.push(["R", n.x, n.y, t.x, b]), y = o.path2Absolute(y), x || (x = s.addGroup({
					elCls: "x-line-group"
		...
		var h = n(1),
			...
			v = f.registGeom("area", {
				...
				drawShape: function(t, e, n) {
					...
					return i = 1 === e.points.length ? l(this, e, n) : r.drawShape(e, n), i && (i.set("origin", e.origin), i.animateType = i.animateType ? i.animateType : e.geomType, i.id = e.id, e.splitedIndex && (i.id += "splI" + e.splitedIndex)), i
				}
			});
		...
		h.registShape("edge", "line", {
			...
			drawShape: function(t, e) {
				...
				if (t.isInCircle) {
					...
					var g = r(s[1], s[3]),
						p = r(s[2], s[0]);
					a.push(g), a.push(["L", s[3].x, s[3].y]), a.push(["L", s[2].x, s[2].y]), a.push(p), a.push(["Z"]), a = this.parsePath(a), h.fill = h.stroke, n = e.addShape("path", {
						attrs: l.mix(h, {
							path: a
						})
					})
		...
		var g = n(1),
			...
			_ = v.registGeom("line", {
				...
				drawShape: function(t, e, n) {
					var i, r = this.getShape(t);
					return i = 1 === e.points.length ? f(this, e, n) : r.drawShape(e, n), i && (i.set("origin", e.origin), i.animateType = i.animateType ? i.animateType : e.geomType, i.id = e.id, e.splitedIndex && (i.id += "splI" + e.splitedIndex)), i
				}
			});
